...
import burp.vaycore.ost.ui.widget.FpTestResultPanel;
 ...
 */
public class OstInfoTab implements IMessageEditorTab {
    ...
    public OstInfoTab(IBurpExtenderCallbacks callbacks, IMessageEditorController controller) {
